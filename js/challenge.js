"use strict";
function toConsumableArray(a){if(Array.isArray(a))
...
pause.addEventListener("click",function(){
    ...
    [].concat(toConsumableArray(
        document.getElementsByTagName("button"))).forEach(function(a){"pause"!==a.id&&(a.disabled=!playing)})}),
